...
### Custom Icon
```tsx
import { QuestionIcon, WarningCircleIcon } from './icons';
...
<Popconfirm
  title="Are you sure?"
  icon={<QuestionIcon color={token.colorError} weight="fill" />}
  onConfirm={handleConfirm}
>
  <Button>Confirm</Button>
</Popconfirm>

// With warning icon (default style)
<Popconfirm
  title="Delete this item?"
  icon={<WarningCircleIcon color={token.colorWarning} weight="fill" />}
  onConfirm={handleDelete}
>
  <Button danger>Delete</Button>
</Popconfirm>
