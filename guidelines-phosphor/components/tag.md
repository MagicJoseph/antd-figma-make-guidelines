...
### With Icons
```tsx
import { TwitterLogoIcon, YoutubeLogoIcon, FacebookLogoIcon, WarningIcon, XIcon } from './icons';

<Tag icon={<TwitterLogoIcon weight="fill" />} color="#55acee">Twitter</Tag>
<Tag icon={<YoutubeLogoIcon weight="fill" />} color="#cd201f">Youtube</Tag>
<Tag icon={<FacebookLogoIcon weight="fill" />} color="#3b5999">Facebook</Tag>
...
<Tag color="warning" icon={<WarningIcon weight="fill" />}>
  Warning
</Tag>
```
