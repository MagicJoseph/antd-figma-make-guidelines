...
```tsx
import { PencilSimpleIcon, TrashIcon } from './icons';

<Space>
  <Tooltip title="Edit">
    <Button type="text" icon={<PencilSimpleIcon weight="regular" />} />
  </Tooltip>
  <Tooltip title="Delete">
    <Button type="text" danger icon={<TrashIcon weight="regular" />} />
  </Tooltip>
</Space>
```
