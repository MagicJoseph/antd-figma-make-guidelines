...
### Card with Actions
```tsx
import { GearIcon, PencilSimpleIcon, DotsThreeIcon } from './icons';

<Card
  style={{ width: 300 }}
  actions={[
    <GearIcon key="setting" weight="regular" />,
    <PencilSimpleIcon key="edit" weight="regular" />,
    <DotsThreeIcon key="ellipsis" weight="bold" />,
  ]}
>
  <Card.Meta
    avatar={<Avatar src="/avatar.png" />}
